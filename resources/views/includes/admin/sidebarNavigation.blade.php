    ...
    <nav class="sidebar-nav">
        ...
        <!-- ************************************************************************************************* -->
            ...
            @if(Auth::user()->author == true )
                ...
                <li class="nav-item nav-dropdown">
                    <a href="{{ route('authorPost') }}"
                       class="nav-link {{Route::currentRouteName() == 'authorPost' ? 'active' :  ''}}">
            ...
            @if(Auth::user()->admin  == true)
                ...
                <li class="nav-item nav-dropdown">
                    <a href="{{ route('adminPost') }}"
                       class="nav-link {{Route::currentRouteName() == 'adminPost' ? 'active' :  ''}}">
                        <i class="icon icon-paper-clip"></i> Post
                    </a>
                </li>
                <li class="nav-item nav-dropdown">
                ...
                <li class="nav-item nav-dropdown">
                    <a href="{{ route('adminInfo') }}"
                       class="nav-link {{ Route::currentRouteName() == 'adminInfo' ? 'active' :  ''}} ">
                        <i class="icon icon-info"></i> Info
                    </a>
                </li>
            @endif
        </ul>
